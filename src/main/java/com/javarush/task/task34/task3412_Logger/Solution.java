package com.javarush.task.task34.task3412_Logger;
...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (InputStream is = new FileInputStream(path.toFile())) {
            ...
            Solution solution = new Solution(10, "value", new Date());
            solution.setValue1(11);
            solution.setValue2(String.valueOf(solution.value1));
            solution.calculateAndSetValue3(Long.MAX_VALUE);
